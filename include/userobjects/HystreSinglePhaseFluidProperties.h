 ...
 */
class HystreSinglePhaseFluidProperties : public FluidProperties
{
public:
  static InputParameters validParams();

  HystreSinglePhaseFluidProperties(const InputParameters & parameters);
  virtual ~HystreSinglePhaseFluidProperties();
...
#undef propfuncAD
  ...
  virtual void rho_mu_from_p_T(Real p,
                               ...
                               Real & dmu_dT) const;
  virtual void
  rho_mu_from_p_T(const ADReal & p, const ADReal & T, ADReal & rho, ADReal & mu) const;
