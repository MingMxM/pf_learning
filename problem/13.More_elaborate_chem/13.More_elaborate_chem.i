...
# Some of the equilibrium constants have been chosen rather aribitarity.
#
...
# to dissolve immediately, increaseing the concentrations of the primary species.
#
...
[Preconditioning]
  ...
  [basic]
    type = SMP
    full = true
    petsc_options = '-ksp_diagomal_scale -ksp_diagomal_scale_fix'
