...
InputParameters
HystreSinglePhaseFluidProperties::validParams()
{
...
HystreSinglePhaseFluidProperties::HystreSinglePhaseFluidProperties(
...
Real
HystreSinglePhaseFluidProperties::e_from_p_T(Real p, Real T) const
{
...
void
HystreSinglePhaseFluidProperties::e_from_p_T(
...
Real
HystreSinglePhaseFluidProperties::v_from_p_T(Real p, Real T) const
{
  const Real rho = rho_from_p_T(p, T);
  return 1.0 / rho;
}
...
void
HystreSinglePhaseFluidProperties::v_from_p_T(
    Real p, Real T, Real & v, Real & dv_dp, Real & dv_dT) const
{
...
void
HystreSinglePhaseFluidProperties::beta_from_p_T(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " is not implemented.");
}

Real
HystreSinglePhaseFluidProperties::beta_from_p_T(Real p, Real T) const
{
...
Real
HystreSinglePhaseFluidProperties::molarMass() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

std::string
HystreSinglePhaseFluidProperties::fluidName() const
{
  return std::string("");
}

Real
HystreSinglePhaseFluidProperties::criticalPressure() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::criticalTemperature() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::criticalDensity() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::criticalInternalEnergy() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::triplePointPressure() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::triplePointTemperature() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::gamma_from_v_e(Real v, Real e) const
{
  return cp_from_v_e(v, e) / cv_from_v_e(v, e);
}

void
HystreSinglePhaseFluidProperties::gamma_from_v_e(
...
Real
HystreSinglePhaseFluidProperties::gamma_from_p_T(Real p, Real T) const
{
  return cp_from_p_T(p, T) / cv_from_p_T(p, T);
}

void
HystreSinglePhaseFluidProperties::gamma_from_p_T(
...
Real HystreSinglePhaseFluidProperties::vaporPressure(Real) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

std::vector<Real>
HystreSinglePhaseFluidProperties::henryCoefficients() const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

void
HystreSinglePhaseFluidProperties::vaporPressure(Real T, Real & p, Real & dp_dT) const
{
  fluidPropError(name(), ": ", __PRETTY_FUNCTION__, " derivatives not implemented.");
...
ADReal
HystreSinglePhaseFluidProperties::vaporPressure(const ADReal & T) const
{
  Real p = 0.0;
...
Real HystreSinglePhaseFluidProperties::vaporTemperature(Real) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

void
HystreSinglePhaseFluidProperties::vaporTemperature(Real p, Real & T, Real & dT_dp) const
{
  fluidPropError(name(), ": ", __PRETTY_FUNCTION__, " derivatives not implemented.");
...
ADReal
HystreSinglePhaseFluidProperties::vaporTemperature(const ADReal & p) const
{
  Real T = 0.0;
...
void
HystreSinglePhaseFluidProperties::rho_e_from_p_T(Real p,
                                                 Real T,
                                                 Real & rho,
                                                 Real & drho_dp,
                                                 Real & drho_dT,
...
void
HystreSinglePhaseFluidProperties::rho_mu_from_p_T(Real p, Real T, Real & rho, Real & mu) const
{
...
void
HystreSinglePhaseFluidProperties::rho_mu_from_p_T(Real p,
                                                  Real T,
                                                  Real & rho,
                                                  Real & drho_dp,
                                                  Real & drho_dT,
...
void
HystreSinglePhaseFluidProperties::rho_mu_from_p_T(const ADReal & p,
                                                  const ADReal & T,
                                                  ADReal & rho,
                                                  ADReal & mu) const
{
...
Real HystreSinglePhaseFluidProperties::e_spndl_from_v(Real) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

void
HystreSinglePhaseFluidProperties::v_e_spndl_from_T(Real, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

Real
HystreSinglePhaseFluidProperties::T_from_p_h(Real p, Real h) const
{
...
void
HystreSinglePhaseFluidProperties::T_from_p_h(
